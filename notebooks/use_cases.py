...
def _iotm2m():
    ...
    # Define targets
    use_case['T_bitorbit_target'] = 2.5 * 8 * 1e9  # Throughput per orbit [bit]
    use_case['L_sorbit_target'] = 60
    use_case['E_Jorbit_target'] = 20 * use_case['T_orbit_s'] * 0.145  # Energy consumption per orbit [J]
    use_case['P_sorbit_target'] = 0

    # Define constraints
    use_case['T_bitorbit_min'] = use_case['T_bitorbit_target']
    use_case['T_bitorbit_max'] = -1

    use_case['E_Jorbit_max'] = -1 #use_case['E_Jorbit_target'] * 100
    use_case['L_sorbit_max'] = -1 #300 # Maximum gap in Telesat constellation
...
def _eo():
    ...
    use_case['E_Jorbit_max'] = -1 #use_case['E_Jorbit_target'] * 2
