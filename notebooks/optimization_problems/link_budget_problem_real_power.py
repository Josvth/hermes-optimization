...
from notebooks.optimization_problems.design_vector import design_vector_indices, explode_design_vector, design_vector_bounds

class LinkBudgetProblemRealPower(Problem):
    ...
    def __init__(self, instances_df, system_parameters, single_power=True, *args, **kwargs):
        ...
        self.xl, self.xu = design_vector_bounds(self.x_length, self.x_indices, self.sys_param, real_power=True)
