...
def max_contact_biased(instances_df, sys_param, case, pop_size, n_partitions=100, plot = True, init='random'):
    ...
    if init == 'max':
        print("Generating initial population of size %d..." % pop_size)
        sample_pop = init_problem.xu
    if init == 'min':
        sample_pop = init_problem.xl
