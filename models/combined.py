...
@njit
def compute_fg_no_down_select(N_passes, O_matrix, t_sim_s, tof_s_list, fspl_dB_list, theta_rad_list, phi_rad_list,
    ...
    # Downselect passes
    x_pass = contact.down_select_passes(x_pass, O_matrix)
